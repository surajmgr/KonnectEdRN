	...
	return (
		<View className="gap-3">
			...
			>
				...
				<Text className="text-gray-900 dark:text-gray-100 font-medium">Continue with Google</Text>
			</Button>
			...
			>
				...
				<Text className="text-gray-900 dark:text-gray-100 font-medium">Continue with Passkey</Text>
			</Button>
			...
			{false && (
				...
				>
					<Text className="text-gray-900 dark:text-gray-100 font-medium">Continue as Guest</Text>
				</Button>
			)}
		</View>
	);
