    ...
    <Tabs
      ...
      tabBar={(props) => (
        <TabBar
          ...
          backgroundColor={getColor({ value: "tabBarBackgroundColor", mode: currentScheme })}
          ...
          {props.state.routes.map((route, index) => {
            ...
            return (
              <TabItem
                ...
                focusedColor={config.focusedColor || getColor({ value: "tabBarFocusedColor", mode: currentScheme })}
                unfocusedColor={config.unfocusedColor || getColor({ value: "tabBarUnfocusedColor", mode: currentScheme })}
                pillBackgroundColor={config.pillBackgroundColor || getColor({ value: "tabBarPillBackgroundColor", mode: currentScheme })}
